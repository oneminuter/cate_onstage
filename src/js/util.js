var util = {
	...
	toast:function(text){
		...
		toast.style.cssText = 'background-color: rgba(0, 0, 0, 0.4);width: 200px;position: absolute;top: 20%;z-index: 3;left: 50%;margin-left: -100px;color: rgba(255, 255, 255, 0.65);padding: 8px;border-radius: 8px;text-align: center;';
